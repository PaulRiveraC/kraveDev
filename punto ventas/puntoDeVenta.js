calcularValorTotal = function(){
    ...
    valorDescuento=calcularValorDescuento(cantidad,precioProducto);
    ...
    mostrarTexto("lblResumen","valor a pagar por "+cantidad+ " "+nombreProducto+" con un valor de $"+precioProducto+" es "+valorTotal);
}   
